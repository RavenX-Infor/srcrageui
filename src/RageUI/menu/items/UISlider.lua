...
local SettingsSlider = {
    ...
    LeftArrow = { Dictionary = "commonmenustafftu", Texture = "arrowleft", X = 235, Y = 11.5, Width = 15, Height = 15 },
    RightArrow = { Dictionary = "commonmenustafftu", Texture = "arrowright", X = 400, Y = 11.5, Width = 15, Height = 15 },
}
