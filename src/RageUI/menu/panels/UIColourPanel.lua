...
local Colour = {
    ...
    LeftArrow = { Dictionary = "commonmenustaff", Texture = "arrowleft", X = 7.5, Y = 15, Width = 30, Height = 30 },
    RightArrow = { Dictionary = "commonmenustaff", Texture = "arrowright", X = 393.5, Y = 15, Width = 30, Height = 30 },
